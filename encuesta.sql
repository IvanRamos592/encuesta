...
(1, '¿Tienes conocimiento en HTML5?', 1),
(2, '¿Tienes conocimiento de CSS3?', 1),
(3, '¿Te gusta el desarrollo web?', 1),
(4, '¿Te gusta la programacion?', 1),
(5, '¿Sabes el lenguaje de programación Flutter?', 1),
(6, '¿Tienes conocimiento en JavaScript?', 1),
(7, '¿Sabes NodeJS?', 1),
(8, '¿Te gusta lenguaje de programación PHP?', 1),
(9, '¿Tienes conocimiento de Laravel?', 1),
(10, '¿Te gustaría desarrollar aplicaciones móviles?', 1);
